...
export class ProfileView extends React.Component {
  ...
  getUser(token) {
    ...
    axios
      .get(`http://clemflixdb.herokuapp.com/users/${username}`, {
  ...
  deleteFavoriteMovie(movieId) {
    ...
    axios
      .delete(
        `http://clemflixdb.herokuapp.com/users/${localStorage.getItem(
          "user"
        )}/Movies/${movieId}`,
        {
  ...
  deleteUser(e) {
    axios
      .delete(
        `http://clemflixdb.herokuapp.com/users/${localStorage.getItem("user")}`,
        {
          headers: { Authorization: `Bearer ${localStorage.getItem("token")}` },
        }
      )
